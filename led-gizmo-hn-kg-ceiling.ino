...
const char *defaultDeviceName = PROGMEM "Ceiling";
...
#define LED_BUFFER_SIZE_COLLAR 506
...
uint8_t fireCache[LED_BUFFER_SIZE_COLLAR] = { 0 };
...
void AnimateFire(float frameTime)
{
	...
	uint8_t nDecay[LED_BUFFER_SIZE_COLLAR] = { 0 };

	fill_raw_noise8(n, LED_BUFFER_SIZE_COLLAR, 1, 0, 64 - 60 * noiseScale, millis() * speed);
	fill_raw_noise8(nDecay, LED_BUFFER_SIZE_COLLAR, 1, 0, 196, millis() * speed * 10);
